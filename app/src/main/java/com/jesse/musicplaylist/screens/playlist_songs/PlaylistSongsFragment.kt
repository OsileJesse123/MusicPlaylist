...
class PlaylistSongsFragment : Fragment() {
    ...
    private val playlistSongsAdapter = SongsAdapter()
    private val playlistSongsViewModel by lazy {
       requireActivity().obtainViewModel(PlaylistSongsViewModel::class.java)
    }
